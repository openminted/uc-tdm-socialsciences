package eu.openminted.uc_tdm_socialsciences.kb.preparation.main;

import java.nio.file.Paths;

import eu.openminted.uc_tdm_socialsciences.kb.preparation.util.input.DocReader;
import eu.openminted.uc_tdm_socialsciences.kb.preparation.util.input.GoldDataReader;
import eu.openminted.uc_tdm_socialsciences.kb.preparation.util.input.StudyReader;
