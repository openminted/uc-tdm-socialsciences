...
/**
 * Changes:
 *  modified process() method so it can handle BIO-encoded annotations
 */
...
public class MyStanfordNamedEntityRecognizer
            ...
            extends ModelProviderBase<AbstractSequenceClassifier<CoreMap>>
    {
                ...
                throws IOException
        {
            ...
            try {
                ...
                AbstractSequenceClassifier<CoreMap> classifier = CRFClassifier.getClassifier(is);
