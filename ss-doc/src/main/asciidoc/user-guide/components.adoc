...
How much is needed is highly dependent on the number and type of features, on the amount of training data and on the number of different class labels in the training data.
